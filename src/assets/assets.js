...
export const categories = ["People", "Animals", "Graphics", "Products", "Cars"];
...
export const testimonials = [
  {
    id: 1,
    quote:
      "This platform has transformed the way we handle our projects. The simplicity and accuracy are unmatched.",
  ...
  },
  {
    id: 2,
    quote:
      "Our workflow is now smoother and faster than ever. The results consistently exceed our expectations.",
  ...
  },
  {
    id: 3,
    quote:
      "I was blown away by the quality and attention to detail. It feels like we leveled up our entire business overnight.",
    author: "Priya Sharma",
